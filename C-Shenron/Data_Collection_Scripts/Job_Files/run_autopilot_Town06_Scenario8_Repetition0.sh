...
# Evaluation Setup
export ROUTES=/radar-imaging-dataset/Pushkal//leaderboard/data/training/routes/s8/Town06_Scenario8.xml
export SCENARIOS=/radar-imaging-dataset/Pushkal/leaderboard/data/training/scenarios/s8/Town06_Scenario8.json
...
export CHECKPOINT_ENDPOINT=/radar-imaging-dataset/Pushkal/datagen_carla_garage/hb_dataset_v08_2024_09_09/s8_dataset_2024_09_09/Routes_Town06_Scenario8_Repetition0/Dataset_generation_Town06_Scenario8_Repetition0.json # output results file
export SAVE_PATH=/radar-imaging-dataset/Pushkal/datagen_carla_garage/hb_dataset_v08_2024_09_09/s8_dataset_2024_09_09/Routes_Town06_Scenario8_Repetition0 # path for saving episodes (comment to disable)
echo 'creating checkpoint and save_path directory...'
sleep 2s
mkdir -p ${SAVE_PATH}
touch ${SAVE_PATH}/Dataset_generation_Town06_Scenario8_Repetition0.json
...
cp -r /home/user/datagen_carla_garage/hb_dataset_v08_2023_05_10/s8_dataset_2024_09_09/Routes_Town06_Scenario8_Repetition0/ /radar-imaging-dataset/carla_garage_data/s8_dataset_2024_09_09/
