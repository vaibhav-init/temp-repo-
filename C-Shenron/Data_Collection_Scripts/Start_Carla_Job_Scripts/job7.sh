...
chmod u+x /radar-imaging-dataset/Pushkal/Data_Collection_Scripts/Job_Files/run_autopilot_Town05_Scenario8_Repetition0.sh


/radar-imaging-dataset/Pushkal/Data_Collection_Scripts/Job_Files/run_autopilot_Town05_Scenario8_Repetition0.sh
